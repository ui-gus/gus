		...
		<tr>
			...
			<td>
				<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
					<tr>
						<td colspan="3" bgcolor="#E6E6E6"><strong>Edit Thread</strong> </td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><textarea name="thread_body" cols="70" rows="3" id="edit_thread_body"><?php	echo $this->fdata['thread_body']; ?></textarea></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
